...
`,
      ...
      },
      {
        ...
        reference_solution_ref: "AntiNoise-ai/trapstreet-mvp/cli/examples/word-count/solution",
        ranking_metric: "total_score",
        ranking_direction: "desc",
...
`,
      ...
      },
      {
        ...
        reference_solution_ref: "AntiNoise-ai/trapstreet-mvp/cli/examples/echo/solution",
    ...
    .values([
      {
        ...
        grader_metrics: {
          ...
          n_passed: 4,
          n_total: 4,
          latency_ms_total: 1240,
          latency_ms_median: 310,
          cost_usd_total: 0.0089,
          tokens_total: 2104,
        },
        metadata: { model: "claude-3.5-sonnet", framework: "claude-code-skill" },
      ...
      },
      {
        ...
        grader_metrics: {
          ...
          latency_ms_median: 78,
          cost_usd_total: 0.0001,
        },
        metadata: { framework: "regex-rules", notes: "no LLM, pure pattern match" },
      ...
      },
      {
        ...
        grader_metrics: {
          ...
          latency_ms_median: 625,
          cost_usd_total: 0.018,
          tokens_total: 3100,
        },
        metadata: { model: "gpt-4o", framework: "openai-thinking", max_tokens: 8000 },
      ...
      },
      {
        ...
        grader_metrics: {
          ...
          latency_ms_median: 600,
          latency_ms_p95: 1200,
          cost_usd_total: 0.045,
          tokens_total: 5210,
          by_category: { money: 1.0, clauses: 0.75, scenario: 1.0, scenario_reasoning: 0.0 },
        },
        metadata: { model: "claude-3.5-sonnet", framework: "claude-code-skill", system_prompt: "extract verbatim from PDF" },
      ...
      },
      {
        ...
        grader_metrics: {
          ...
          n_total: 8,
          threshold: 0.8,
          latency_ms_total: 7200,
          latency_ms_median: 900,
          latency_ms_p95: 1500,
          cost_usd_total: 0.072,
          tokens_total: 8900,
          by_category: { money: 1.0, clauses: 0.50, scenario: 0.50, scenario_reasoning: 0.50 },
        },
        metadata: { model: "gpt-4o", framework: "openai-thinking" },
      ...
      // latency-sorted leaderboard for this task.
      {
        ...
        metadata: { framework: "bash-echo", notes: "literally /bin/echo" },
      ...
      },
      {
        ...
        grader_metrics: {
          ...
          n_passed: 1,
          n_total: 1,
          latency_ms_total: 1600,
          cost_usd_total: 0.0015,
          tokens_total: 24,
        },
        metadata: { model: "gpt-4o", framework: "openai-thinking" },
