...
// Inline "new thread on this subject" form on /threads?subject_type=...
// Used for non-task subjects (e.g. a specific run) where the task forum
// tab doesn't apply.
export default function NewThreadForFilter({
  subjectType,
  subjectId,
}: {
  subjectType: string;
  ...
  if (!open) {
    return (
      ...
      >
        + new thread on {subjectType}/{subjectId}
      </button>
    );
  }
